...
List<ProjectUtils> workProjectUtils = [
  ...
  ProjectUtils(
    ...
    'Introduction\n'
        ...
        '   3. Completed a proof of concept (POC) for extracting metadata content from the database repository and was able to retrieve 40-50% of data through automated queries,'
  ...
  ProjectUtils(
    ...
    'Introduction\n'
        ...
        ' 1 hour and 15 minutes to run on Spark compared to 15 hours in Oracle.\n'
        '\n'
        'Major Bug Fixed\n'
        '   No bugs.\n'
        '\n'
